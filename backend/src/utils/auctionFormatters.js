...
const formatAuction = (auction) => ({
  ...
  resultReason: auction.resultReason || null,
  winner: formatUserRef(auction.winner),
  winnerParticipantNumber: auction.winnerParticipantNumber || null,
  winningBidAmount: auction.winningBidAmount || null,
  winningBidAt: auction.winningBidAt || null,
  extendedAt: auction.extendedAt || null,
